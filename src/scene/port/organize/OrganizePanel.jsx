...
export const OrganizePanel = (props) => {
    ...
    return (
        <Container x={0} y={0}>
            ...
            {/* 艦船リスト */}
            <ShipCard fleet={fleet} shipIndex={0} api_ship={api_ship} lastShipIndex={lastShipIndex} getData={props.getData} x={180} y={198} />
            <ShipCard fleet={fleet} shipIndex={1} api_ship={api_ship} lastShipIndex={lastShipIndex} getData={props.getData} x={693} y={198} />
            <ShipCard fleet={fleet} shipIndex={2} api_ship={api_ship} lastShipIndex={lastShipIndex} getData={props.getData} x={180} y={366} />
            <ShipCard fleet={fleet} shipIndex={3} api_ship={api_ship} lastShipIndex={lastShipIndex} getData={props.getData} x={693} y={366} />
            <ShipCard fleet={fleet} shipIndex={4} api_ship={api_ship} lastShipIndex={lastShipIndex} getData={props.getData} x={180} y={534} />
            <ShipCard fleet={fleet} shipIndex={5} api_ship={api_ship} lastShipIndex={lastShipIndex} getData={props.getData} x={693} y={534} />
        </Container>
    );
};