...
export class PortSideMenu{
    constructor(config) {
        ...
        PIXI.Assets.load("assets/kcs2/img/port/port_sidemenu.json").then((data) => {
            // backgtround
            this.bg1 = new PIXI.Sprite(data.textures.port_sidemenu_0);
            this.bg1.position.set(0,200);
            this.bg2 = new PIXI.Sprite(data.textures.port_sidemenu_1);
            this.bg2.position.set(0,200);
            // 吊车
