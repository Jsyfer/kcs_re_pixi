...
export class PortBackground{
    ...
    create = async () => {
        ...
        // panel bg
        this.panelBackground = PIXI.Sprite.from('assets/kcs2/img/common/bg/011.png');
    ...
    // 编成事件
    henseiEvent = () => {
      this.panelBackground.texture = PIXI.Texture.from('assets/kcs2/img/common/bg/011.png');
      this.hideAll();
    }
    // 補給事件
    hokyuuEvent = () => {
      this.panelBackground.texture = PIXI.Texture.from('assets/kcs2/img/common/bg/012.png');
      this.hideAll();
    }
    // 改装事件
    kaisouEvent = () => {
      this.panelBackground.texture = PIXI.Texture.from('assets/kcs2/img/common/bg/013.png');
      this.hideAll();
    }
    // 入渠事件
    nyuukyoEvent = () => {
      this.panelBackground.texture = PIXI.Texture.from('assets/kcs2/img/common/bg/014.png');
      this.hideAll();
    }
    // 工廠事件
    koujyouEvent = () => {
      this.panelBackground.texture = PIXI.Texture.from('assets/kcs2/img/common/bg/015.png');
      this.hideAll();
    }
